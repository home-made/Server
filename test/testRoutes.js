...
describe("Routes", function() {
  it("should update a user profile on /user/:userId PUT", function(done) {
    chai.request(server).put("/user/:userId").end(function(err, res) {
  ...
  it("should post a user profile on /user/:userId POST", function(done) {
    chai.request(server).post("/user/:userId").end(function(err, res) {
      res.should.have.status(200);
      done();
    });
  });
  ...
  it("should list chef + dishes on /chef/:chefId GET", function(done) {
    chai.request(server).get("/chef/:chefId").end(function(err, res) {
      res.should.have.status(200);
      done();
    });
  });
  ...
  it("should post a new dish on /dish/add POST", function(done) {
    chai.request(server).post("/dish/add").end(function(err, res) {
      res.should.have.status(200);
      done();
    });
  });
  ...
  it("should update a dish on /dish/:id PUT", function(done) {
    chai.request(server).put("/dish/:id").end(function(err, res) {
      res.should.have.status(200);
      done();
    });
  });
  ...
  it("should list active orders on /orders/:id GET", function(done) {
    chai.request(server).get("/orders/:id").end(function(err, res) {
      res.should.have.status(200);
      done();
    });
  });
  ...
  it("should list inactive orders on /orders/all/:id GET", function(done) {
    chai.request(server).get("/orders/all/:id").end(function(err, res) {
      res.should.have.status(200);
      done();
    });
  });
  ...
  it("should list pending requests on /orders/ GET", function(done) {
    chai.request(server).get("/orders/").end(function(err, res) {
      res.should.have.status(200);
      done();
    });
  });
  ...
  it("should post a new review on /review/:type/:id POST", function(done) {
    chai.request(server).post("/review/:type/:id").end(function(err, res) {
      res.should.have.status(200);
      done();
    });
  });
